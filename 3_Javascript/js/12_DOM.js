...
// 4) 중간에 존재하는 자식 노드 검색 : 부모요소.childNodes[인덱스]
...
console.log(nodeList[8].nextsSibling);
...
document.getElementById("btn3-2").addEventListener("click",function(){
    ...
    const child = document.createElement("div"); // div O, 화면 배치 X
